...
console.log(`DKD oyun paketi hazır: ${(Buffer.byteLength(dkd_html) / 1024 / 1024).toFixed(2)} MB. v0.5 · MP3 ses ayrımı · yol-güvenli şehir detayları · Supabase native köprü.`);
