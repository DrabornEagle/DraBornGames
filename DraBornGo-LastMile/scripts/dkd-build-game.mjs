...
console.log(`DKD oyun paketi hazır: ${(Buffer.byteLength(dkd_html) / 1024 / 1024).toFixed(2)} MB. v0.6.1 · cihaz-uyumlu gerçek başlangıç scooter+sürücü · drive-only müzik izolasyonu · sağlam müşteri profilleri · admin seviye 50 · Supabase native köprü.`);
