...
// Historical compatibility layers remain bundled beneath the authoritative v0.7 runtime.
// dkd-v07-device-seat-wheel-camera-fix.mjs MUST remain last: physical-device screenshots
// are authoritative for final rider seating, visible wheel motion and chase-camera migration.
const dkd_sources = [
  'data/dkd-roads.mjs',
  'dkd-data.mjs',
  'dkd-core.mjs',
  ...
  'dkd-v07-release.mjs',
  'dkd-v07-device-polish.mjs',
  'dkd-v07-device-seat-wheel-camera-fix.mjs'
];
...
const dkd_mediaFiles = [
  { dkd_file: 'audio/dkd-v07-home-kurye-merkezi.mp3', dkd_name: 'Kurye Merkezi: Gece Mesaisi', dkd_sub: 'PCM/WAV Master · Full Mix MP3', dkd_bpm: 90, dkd_mode: 'menu' },
  { dkd_file: 'audio/dkd-v07-drive-ankara-gece.mp3', dkd_name: 'Ankara: Gece Trafiği', dkd_sub: 'PCM/WAV Master · Full Mix MP3', dkd_bpm: 122, dkd_mode: 'drive' },
  { dkd_file: 'audio/dkd-v07-drive-son-kilometre.mp3', dkd_name: 'Son Kilometre: Baskı', dkd_sub: 'PCM/WAV Master · Full Mix MP3', dkd_bpm: 128, dkd_mode: 'drive' },
  { dkd_file: 'audio/dkd-v07-drive-firtina-hatti.mp3', dkd_name: 'Fırtına Altında', dkd_sub: 'PCM/WAV Master · Full Mix MP3', dkd_bpm: 132, dkd_mode: 'drive' },
  { dkd_file: 'audio/dkd-v07-drive-asfalt-yildizlari.mp3', dkd_name: 'Asfalt Nabzı', dkd_sub: 'PCM/WAV Master · Full Mix MP3', dkd_bpm: 118, dkd_mode: 'drive' },
  { dkd_file: 'audio/dkd-v07-drive-final-kontrat.mp3', dkd_name: 'Final Kontrat: 03:17', dkd_sub: 'PCM/WAV Master · Full Mix MP3', dkd_bpm: 126, dkd_mode: 'drive' },
];
...
console.log(`DKD oyun paketi hazır: ${(Buffer.byteLength(dkd_html) / 1024 / 1024).toFixed(2)} MB. v0.7 · cihaz sele hizası · görünür arka teker dönüşü · Takip/Standart kamera v2 · modern Ayarlar · stereo PCM/WAV→MP3 full-mix · APK üretilmez.`);
