...
// dkd-v07-device-polish.mjs MUST remain last: it owns final rider seating, imported
// wheel animation, default camera migration and premium settings/music surfaces.
const dkd_sources = [
  'data/dkd-roads.mjs',
  'dkd-data.mjs',
  'dkd-core.mjs',
...
console.log(`DKD oyun paketi hazır: ${(Buffer.byteLength(dkd_html) / 1024 / 1024).toFixed(2)} MB. v0.7 · sürücü kendi pivotunda oturtuldu · Yamaha çift teker animasyonu · Takip/Standart kamera · modern Ayarlar · stereo PCM/WAV→MP3 full-mix · APK üretilmez.`);
