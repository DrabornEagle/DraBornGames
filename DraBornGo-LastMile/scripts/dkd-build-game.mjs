...
const dkd_sources = [
  ...
  'dkd-v03-uploaded-model-runtime.mjs'
];
...
console.log(`DKD oyun paketi hazır: ${(Buffer.byteLength(dkd_html) / 1024 / 1024).toFixed(2)} MB. v0.3 · Harici CDN veya çalışma anında ağ isteği yok.`);
