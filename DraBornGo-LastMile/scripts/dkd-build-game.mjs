...
// Historical compatibility layers remain bundled beneath the authoritative v0.5 runtime.
const dkd_sources = [
  'data/dkd-roads.mjs',
  'dkd-data.mjs',
  'dkd-core.mjs',
...
console.log(`DKD oyun paketi hazır: ${(Buffer.byteLength(dkd_html) / 1024 / 1024).toFixed(2)} MB. v0.5 · MP3 özgün müzik · görünür yol çalışması · Supabase native köprü.`);