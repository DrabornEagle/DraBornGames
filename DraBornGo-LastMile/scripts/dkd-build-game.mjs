...
console.log(`DKD oyun paketi hazır: ${(Buffer.byteLength(dkd_html) / 1024 / 1024).toFixed(2)} MB. v0.6 · gerçek sezon · müşteri profil fotoğrafları · admin seviye 50 · plaka kaydı · sunucu final doğrulaması · MP3 ses ayrımı · Supabase native köprü.`);
