...
const dkd_sourceReplacement = "'dkd-v061-final-device-fix.mjs','dkd-v07-release.mjs','dkd-v07-premium-rider.mjs','dkd-v07-google-play.mjs','dkd-v072-release.mjs','dkd-v072-hotfix.mjs'";
...
// Android WebView ve web aynı oluşturulmuş HTML paketini kullanır.
dkd_source = dkd_source.replaceAll('v0.6.1', 'v0.7.2');
...
try {
  await import(`${dkd_pathToFileURL(dkd_generatedFile).href}?dkd_v072=${Date.now()}`);
} finally {
