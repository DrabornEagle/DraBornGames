...
import { ActivityIndicator as dkd_ActivityIndicator, Animated as dkd_Animated, AppState as dkd_AppState, BackHandler as dkd_BackHandler, Linking as dkd_Linking, Pressable as dkd_Pressable, Text as dkd_Text, View as dkd_View } from 'react-native';
...
function dkd_Container() {
  ...
  return dkd_createElement(
    ...
    dkd_error
      ...
      : dkd_bootstrap === null
        ? dkd_createElement(dkd_LoadingScreen)
