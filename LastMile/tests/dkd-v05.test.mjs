...
test('historical v0.5 music controls stay bundled beneath the current two-track override', () => {
...
test('historical shift selection layer remains available beneath current override', () => {
