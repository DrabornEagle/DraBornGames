...
test('v0.7.4 retains standard chase camera and physical two-track audio', async () => {
...
test('v0.7.4 continues using only verified InnerLight and SeMeNota music files', async () => {
